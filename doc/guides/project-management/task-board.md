...
- [x] `P0-PM-005` 建立任务模板
- [ ] `P0-PM-006` 约定任务认领流程、更新频率与完成回写方式

## P1：MVP 核心纵切

### 认证与账号

- [x] `P1-AUTH-001` 实现真实 JWT 生成与服务端校验
- [x] `P1-AUTH-002` 打通 Gateway JWT 校验配置
- [x] `P1-AUTH-003` 客户端登录后注入 Bearer Token
...
2. `P0-ENV-002` 初始化团结引擎真实工程
3. `P1-CHAR-001` 登录后角色检查流程
4. `P1-CHAR-002` 角色创建联调
5. `P1-CHAR-004` 玩家数据管理器落地
6. `P1-CULT-001` 修炼进度查询闭环
