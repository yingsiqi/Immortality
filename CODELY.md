...
- [2026-07-21 21:52:29] [project] dotnet build PASSED: 0 error, 0 warning, all 9 projects compiled successfully on 2026-07-21. Fixed 4 build blockers: (1) EventStore.Client v23 renamed to EventStore.Client.Grpc.Streams 23.3.9, (2) Position.FromInt64 removed in v23 → use Position.Start, (3) AddStackExchangeRedisCache needs Microsoft.Extensions.Caching.StackExchangeRedis 8.0.2 package in AuthService/GameService/RealtimeService, (4) CA2007 (ConfigureAwait) blocked by TreatWarningsAsErrors → set to none in .editorconfig. Also global.json rollForward changed from latestMinor to latestFeature for SDK 8.0.423 compatibility. **Why:** SDK 8.0.423 installed, first successful compile. **How to apply:** P0-ENV-001 done; P0-DB-001 (EF Core migrations) is next priority.
